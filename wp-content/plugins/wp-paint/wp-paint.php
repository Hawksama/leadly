...
// // Define Path.
define('WPP_PLUGIN_VERSION', '0.5.1');
define('WPP_PLUGIN_VERSION_HASH', '62662b3df6beb18db7ddc40698174aebd61807cbbac93418');
...
if(!function_exists('wp_paint_register_scripts')) {
  function wp_paint_register_scripts() {
    ...
    wp_register_script('wpp_paint_admin_js', WPP_PLUGIN_URL . "/static/js/wp-paint-admin.min.js", ['media-views', 'wpp_jquery_initialize_js'], WPP_PLUGIN_VERSION_HASH);
