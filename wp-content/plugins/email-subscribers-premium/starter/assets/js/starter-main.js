...
jQuery(document).ready(function(){
	if ( 'undefined' !== typeof ig_es_starter_main_js_params  ) {
		if ( 'yes' === ig_es_starter_main_js_params.show_opt_in_consent && 'yes' === ig_es_starter_main_js_params.session_tracking_enabled && ! jQuery("#ig_es_opt_in_consent_block").length ) {
