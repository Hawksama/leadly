...
/**
 * Class to Ninja Forms data
 *
 * @class ES_Data_Type_Ninja_Forms_Data
 */
class ES_Data_Type_Ninja_Forms_Data extends ES_Workflow_Data_Type {
	...
	public function get_data( $form_saved_data = array() ) {
		...
		if ( is_array( $form_saved_data ) && ! empty( $form_saved_data['email'] ) ) {
			...
			$data['source'] = 'ninja_forms'; // Add source to ninja_forms saved data.
		}
