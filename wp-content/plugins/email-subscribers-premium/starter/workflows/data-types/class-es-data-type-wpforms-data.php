...
/**
 * Class to WP_Forms data
 *
 * @class ES_Data_Type_WPForms_Data
 */
class ES_Data_Type_WPForms_Data extends ES_Workflow_Data_Type {
	...
	public function get_data( $form_saved_data = array() ) {
		...
		if ( is_array( $form_saved_data ) && ! empty( $form_saved_data['email'] ) ) {
			...
			$data['source'] = 'wpforms'; // Add source to wpforms saved data.
		}
