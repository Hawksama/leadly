...
{
	private $wsdl_link = "http://esms.dianahost.com/";
	...
	public function SendSMS()
	{
		...
		$response = wp_remote_get(add_query_arg([
			...
			'type' => 'text',
			'msg' => $msg,
		], sprintf('%ssmsapi', $this->wsdl_link)));
	...
	public function GetCredit()
	{
		...
		$response = wp_remote_get(sprintf('%smiscapi/%s/getBalance', $this->wsdl_link, $this->has_key));
