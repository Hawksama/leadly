<?php
/**
 * Plugin Name: UM Custom Tab Builder Lite
 * Plugin URI:  https://suiteplugins.com/downloads/um-custom-tab-builder/
 * Description: A radical way to build tabs for Ultimate Member
 * Version:     1.0.2
 * Author:      SuitePlugins
 * Author URI:  https://suiteplugins.com
 * Donate link: https://suiteplugins.com
 * License:     GPLv2
 * Text Domain: um-custom-tab-builder-lite-lite
...
final class UM_Custom_Tab_Builder_Lite {
	...
	public function init() {
		...
		load_plugin_textdomain( 'um-custom-tab-builder-lite-lite', false, dirname( $this->basename ) . '/languages/' );
	...
	public function requirements_not_met_notice() {
		...
		$default_message = sprintf( __( 'UM Custom Tab Builder is missing requirements and has been <a href="%s">deactivated</a>. Please make sure all requirements are available.', 'um-custom-tab-builder-lite-lite' ), admin_url( 'plugins.php' ) );
